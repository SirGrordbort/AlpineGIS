...
class OwnershipInfo:
    ...
    def split(self):
         selectedFST = arcpy.SelectLayerByAttribute_management(self.ownership, "NEW_SELECTION", "PARCEL_INT = 'Fee Simple Title'" )
...
class BufferFault:
    ...
    def makeBuffer(self, bufferInfo):
        bufferedData = arcpy.Buffer_analysis(bufferInfo.fault, bufferInfo.bufferedFault, bufferInfo.bufferDist, bufferInfo.sideType, bufferInfo.endType, bufferInfo.method, bufferInfo.merge)
        return bufferedData
